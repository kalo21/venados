    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="text-center">
          <img src="<?= base_url(); ?>/assets/images/logo2.png" alt="Venados" style="width: 50%">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <!-- <li class="treeview">
        ...
        <li><a href="#"><i class="fa fa-circle-o text-red"></i> <span>Capturar informacion</span></a></li>
        <li><a href="#"><i class="fa fa-circle-o text-yellow"></i> <span>Info</span></a></li>
