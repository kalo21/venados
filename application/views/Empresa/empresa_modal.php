...
<form class="form-horizontal" id="frmEmpresa">
   <div class="form-group text-center" id="divImagen">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" value ="<?php echo(isset($datos->nombre)) ? $datos->nombre : '' ;?>" data-nombre="<?php echo(isset($datos->nombre)) ? $datos->nombre : '';?>" class="form-control Letras" id="inpNombre" name="inpNombreE">
        </div>        
    </div>
    <div class="form-group">
