...
<form class="form-horizontal" id="frmEmpresaImagen">
    <div class="row">
        <div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center">
            <div id="divImagenV"> 
                <label for="fotoV" id="labelImgV">  <img style="height: 200px; width:200px;" src="<?= (isset($datos->img_fondo)) ? base_url($datos->img_fondo) : base_url('assets/images/imagen.png')?>" class="img-circles img-responsive text-center" alt="imagen_producto"> </label>
