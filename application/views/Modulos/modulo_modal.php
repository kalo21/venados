...
<form class="form-horizontal" id="frmAgregarModulo">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control" id="inpDescripcion">
        </div> 
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label">Ruta</label>
        <div class="col-sm-9">
            <input type="text" class="form-control" id="inpRuta">
        </div> 
    </div>
    <div class="form-group">
        ...
        <select name="slcicono" data-info="<?php echo(isset($info[0]->icono)) ? $info[0]->icono : '' ?>"class="form-control" id="slcicono">
