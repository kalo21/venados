	...
	<div class="container-fluid">
		<div class="row">
			<div class="form-group col-md-12">
				...
				<input  name="txtnombre" data-info="<?php echo(isset($info[0]->nombre)) ? $info[0]->nombre : '' ?>"  data-id="<?php echo(isset($info[0]->id)) ? $info[0]->id : '' ?>" value="<?php echo(isset($info[0]->nombre)) ? $info[0]->nombre : '' ?>" class="form-control LetrasNumeros" id="txtnombre" placeholder="Ingrese el nombre">
			</div>
		</div>
		<div class="row">
			<div class="form-group col-md-12">
				<label class="control-label" for="txtdescripcion">Descripción</label>
				<input name="txtdescripcion" data-info="<?php echo(isset($info[0]->descripcion)) ? $info[0]->descripcion : '' ?>" value="<?php echo(isset($info[0]->descripcion)) ? $info[0]->descripcion : '' ?>" class="form-control" id="txtdescripcion" placeholder="Ingrese una breve descripción">
			</div>
		</div>
		<div class="row">
			<div class="form-group col-md-6">
				<label class="control-label" for="txtruta">Ruta</label>
				<input name="txtruta" data-info="<?php echo(isset($info[0]->ruta)) ? $info[0]->ruta : '' ?>" value="<?php echo(isset($info[0]->ruta)) ? $info[0]->ruta : '' ?>" class="form-control" id="txtruta" placeholder="Ingrese una ruta">
			</div>
			<div class="form-group col-md-6">
				<style>
					#txticono{
				...
				<select name="txticono" data-info="<?php echo(isset($info[0]->icono)) ? $info[0]->icono : '' ?>"class="form-control" id="txticono">
					<optgroup label="Seleccione una opción">
						...
						<option value='fa fa-align-center'>&#xf037; fa-align-center</option>
						<option value='fa fa-align-justify'>&#xf039; fa-align-justify</option>
						...
						<option value='fa fa-angle-down'>&#xf107; fa-angle-down</option>
						...
						<option value='fa fa-barcode'>&#xf02a; fa-barcode</option>
						<option value='fa fa-bars'>&#xf0c9; fa-bars</option>
						<option value='fa fa-battery'>&#xf240; fa-battery</option>
						<option value='fa fa-battery-0'>&#xf244; fa-battery-0</option>
						<option value='fa fa-battery-1'>&#xf243; fa-battery-1</option>
						<option value='fa fa-battery-2'>&#xf242; fa-battery-2</option>
						<option value='fa fa-battery-3'>&#xf241; fa-battery-3</option>
						<option value='fa fa-battery-4'>&#xf240; fa-battery-4</option>
						<option value='fa fa-battery-empty'>&#xf244; fa-battery-empty</option>
						<option value='fa fa-battery-full'>&#xf240; fa-battery-full</option>
						<option value='fa fa-battery-half'>&#xf242; fa-battery-half</option>
						<option value='fa fa-battery-quarter'>&#xf243; fa-battery-quarter</option>
						<option value='fa fa-battery-three-quarters'>&#xf241; fa-battery-three-quarters</option>
						<option value='fa fa-bed'>&#xf236; fa-bed</option>
						...
						<option value='fa fa-braille'>&#xf2a1; fa-braille</option>
						...
						<option value='fa fa-buysellads'>&#xf20d; fa-buysellads</option>
						...
						<option value='fa fa-camera-retro'>&#xf083; fa-camera-retro</option>
						<option value='fa fa-car'>&#xf1b9; fa-car</option>
						<option value='fa fa-caret-down'>&#xf0d7; fa-caret-down</option>
						<option value='fa fa-caret-left'>&#xf0d9; fa-caret-left</option>
						<option value='fa fa-caret-right'>&#xf0da; fa-caret-right</option>
						...
						<option value='fa fa-cart-arrow-down'>&#xf218; fa-cart-arrow-down</option>
						...
						<option value='fa fa-cc-diners-club'>&#xf24c; fa-cc-diners-club</option>
						<option value='fa fa-cc-discover'>&#xf1f2; fa-cc-discover</option>
						<option value='fa fa-cc-jcb'>&#xf24b; fa-cc-jcb</option>
						<option value='fa fa-cc-mastercard'>&#xf1f1; fa-cc-mastercard</option>
						...
						<option value='fa fa-chain-broken'>&#xf127; fa-chain-broken</option>
						<option value='fa fa-check'>&#xf00c; fa-check</option>
						<option value='fa fa-check-circle'>&#xf058; fa-check-circle</option>
						<option value='fa fa-check-circle-o'>&#xf05d; fa-check-circle-o</option>
						<option value='fa fa-check-square'>&#xf14a; fa-check-square</option>
						<option value='fa fa-check-square-o'>&#xf046; fa-check-square-o</option>
						<option value='fa fa-chevron-circle-down'>&#xf13a; fa-chevron-circle-down</option>
						<option value='fa fa-chevron-circle-left'>&#xf137; fa-chevron-circle-left</option>
						<option value='fa fa-chevron-circle-right'>&#xf138; fa fa-chevron-circle-right</option>
						<option value='fa fa-chevron-circle-up'>&#xf139; fa-chevron-circle-up</option>
						<option value='fa fa-chevron-down'>&#xf078; fa-chevron-down</option>
						...
						<option value='fa fa-envelope-square'>&#xf199; fa-envelope-square</option>
						<option value='fa fa-eraser'>&#xf12d; fa-eraser</option>
						...
						<option value='fa fa-mail-forward'>&#xf064; fa-mail-forward</option>
						<option value='fa fa-mail-reply'>&#xf112; fa-mail-reply</option>
						<option value='fa fa-mail-reply-all'>&#xf122; fa-mail-reply-all</option>
						<option value='fa fa-male'>&#xf183; fa-male</option>
						<option value='fa fa-map'>&#xf279; fa-map</option>
						<option value='fa fa-map-marker'>&#xf041; fa-map-marker</option>
						<option value='fa fa-map-o'>&#xf278; fa-map-o</option>
						<option value='fa fa-map-pin'>&#xf276; fa-map-pin</option>
						<option value='fa fa-map-signs'>&#xf277; fa-map-signs</option>
						<option value='fa fa-mars'>&#xf222; fa-mars</option>
						<option value='fa fa-mars-double'>&#xf227; fa-mars-double</option>
						<option value='fa fa-mars-stroke'>&#xf229; fa-mars-stroke</option>
						<option value='fa fa-mars-stroke-h'>&#xf22b; fa-mars-stroke-h</option>
						...
						<option value='fa fa-microphone-slash'>&#xf131; fa-microphone-slash</option>
						<option value='fa fa-minus'>&#xf068; fa-minus</option>
						<option value='fa fa-minus-circle'>&#xf056; fa-minus-circle</option>
						<option value='fa fa-minus-square'>&#xf146; fa-minus-square</option>
						<option value='fa fa-minus-square-o'>&#xf147; fa-minus-square-o</option>
						<option value='fa fa-mobile'>&#xf10b; fa-mobile</option>
						<option value='fa fa-mobile-phone'>&#xf10b; fa-mobile-phone</option>
						...
						<option value='fa fa-odnoklassniki'>&#xf263; fa-odnoklassniki</option>
						<option value='fa fa-odnoklassniki-square'>&#xf264; fa-odnoklassniki-square</option>
						...
						<option value='fa fa-optin-monster'>&#xf23c; fa-optin-monster</option>
						<option value='fa fa-outdent'>&#xf03b; fa-outdent</option>
						<option value='fa fa-pagelines'>&#xf18c; fa-pagelines</option>
						<option value='fa fa-paint-brush'>&#xf1fc; fa-paint-brush</option>
						...
						<option value='fa fa-pencil-square'>&#xf14b; fa-pencil-square</option>
						...
						<option value='fa fa-resistance'>&#xf1d0; fa-resistance</option>
						...
						<option value='fa fa-scissors'>&#xf0c4; fa-scissors</option>
						<option value='fa fa-search'>&#xf002; fa-search</option>
						<option value='fa fa-search-minus'>&#xf010; fa-search-minus</option>
						<option value='fa fa-search-plus'>&#xf00e; fa-search-plus</option>
						<option value='fa fa-sellsy'>&#xf213; fa fa-sellsy</option>
						<option value='fa fa-send'>&#xf1d8; fa-send</option>
						<option value='fa fa-send-o'>&#xf1d9; fa-send-o</option>
						<option value='fa fa-server'>&#xf233; fa-server</option>
						<option value='fa fa-share'>&#xf064; fa-share</option>
						<option value='fa fa-share-alt'>&#xf1e0; fa-share-alt</option>
						<option value='fa fa-share-alt-square'>&#xf1e1; fa-share-alt-square</option>
						<option value='fa fa-share-square'>&#xf14d; fa-share-square</option>
						<option value='fa fa-share-square-o'>&#xf045; fa-share-square-o</option>
						<option value='fa fa-shekel'>&#xf20b; fa-shekel</option>
						<option value='fa fa-sheqel'>&#xf20b; fa-sheqel</option>
						<option value='fa fa-shield'>&#xf132; fa-shield</option>
						<option value='fa fa-ship'>&#xf21a; fa-ship</option>
						<option value='fa fa-shirtsinbulk'>&#xf214; fa-shirtsinbulk</option>
						<option value='fa fa-shopping-cart'>&#xf07a; fa-shopping-cart</option>
						<option value='fa fa-sign-in'>&#xf090; fa-sign-in</option>
						<option value='fa fa-sign-out'>&#xf08b; fa-sign-out</option>
						<option value='fa fa-signal'>&#xf012; fa-signal</option>
						<option value='fa fa-simplybuilt'>&#xf215; fa-simplybuilt</option>
						<option value='fa fa-sitemap'>&#xf0e8; fa-sitemap</option>
						<option value='fa fa-skyatlas'>&#xf216; fa-skyatlas</option>
						<option value='fa fa-skype'>&#xf17e; fa-skype</option>
						<option value='fa fa-slack'>&#xf198; fa-slack</option>
						...
						<option value='fa fa-snapchat-ghost'>&#xf2ac; fa-snapchat-ghost</option>
						<option value='fa fa-snapchat-square'>&#xf2ad; fa-snapchat-square</option>
						<option value='fa fa-snowflake-o'>&#xf2dc; fa-snowflake-o</option>
						<option value='fa fa-soccer-ball-o'>&#xf1e3; fa-soccer-ball-o</option>
						<option value='fa fa-sort'>&#xf0dc; fa-sort</option>
						<option value='fa fa-sort-alpha-asc'>&#xf15d; fa-sort-alpha-asc</option>
						<option value='fa fa-sort-alpha-desc'>&#xf15e; fa-sort-alpha-desc</option>
						<option value='fa fa-sort-amount-asc'>&#xf160; fa-sort-amount-asc</option>
						<option value='fa fa-sort-amount-desc'>&#xf161; fa-sort-amount-desc</option>
						...
						<option value='fa fa-sort-numeric-asc'>&#xf162; fa-sort-numeric-asc</option>
						<option value='fa fa-sort-numeric-desc'>&#xf163; fa-sort-numeric-desc</option>
						<option value='fa fa-sort-up'>&#xf0de; fa-sort-up</option>
						<option value='fa fa-soundcloud'>&#xf1be; fa-soundcloud</option>
						<option value='fa fa-space-shuttle'>&#xf197; fa-space-shuttle</option>
						...
						<option value='fa fa-stack-exchange'>&#xf18d; fa-stack-exchange</option>
						<option value='fa fa-stack-overflow'>&#xf16c; fa-stack-overflow</option>
						<option value='fa fa-star'>&#xf005; fa-star</option>
						<option value='fa fa-star-half'>&#xf089; fa-star-half</option>
						<option value='fa fa-star-half-empty'>&#xf123; fa-star-half-empty</option>
						<option value='fa fa-star-half-full'>&#xf123; fa-star-half-full</option>
						<option value='fa fa-star-half-o'>&#xf123; fa-star-half-o</option>
						<option value='fa fa-star-o'>&#xf006; fa-star-o</option>
						<option value='fa fa-steam'>&#xf1b6; fa-steam</option>
						<option value='fa fa-steam-square'>&#xf1b7; fa-steam-square</option>
						<option value='fa fa-step-backward'>&#xf048; fa-step-backward</option>
						<option value='fa fa-step-forward'>&#xf051; fa-step-forward</option>
						<option value='fa fa-stethoscope'>&#xf0f1; fa-stethoscope</option>
						<option value='fa fa-sticky-note'>&#xf249; fa-sticky-note</option>
						<option value='fa fa-sticky-note-o'>&#xf24a; fa-sticky-note-o</option>
						<option value='fa fa-stop'>&#xf04d; fa-stop</option>
						<option value='fa fa-street-view'>&#xf21d; fa-street-view</option>
						<option value='fa fa-strikethrough'>&#xf0cc; fa-strikethrough</option>
						<option value='fa fa-stumbleupon'>&#xf1a4; fa-stumbleupon</option>
						...
						<option value='fa fa-superscript'>&#xf12b; fa-superscript</option>
						<option value='fa fa-support'>&#xf1cd; fa-support</option>
						<option value='fa fa-table'>&#xf0ce; fa-table</option>
						...
						<option value='fa fa-tasks'>&#xf0ae; fa-tasks</option>
						<option value='fa fa-taxi'>&#xf1ba; fa-taxi</option>
						<option value='fa fa-tencent-weibo'>&#xf1d5; fa-tencent-weibo</option>
						<option value='fa fa-terminal'>&#xf120; fa-terminal</option>
						<option value='fa fa-text-height'>&#xf034; fa-text-height</option>
						<option value='fa fa-text-width'>&#xf035; fa-text-width</option>
						<option value='fa fa-th'>&#xf00a; fa-th</option>
						<option value='fa fa-th-large'>&#xf009; fa-th-large</option>
						...
						<option value='fa fa-thumbs-o-down'>&#xf088; fa-thumbs-o-down</option>
						...
						<option value='fa fa-times-circle-o'>&#xf05c; fa-times-circle-o</option>
						<option value='fa fa-tint'>&#xf043; fa-tint</option>
						...
						<option value='fa fa-toggle-on'>&#xf205; fa-toggle-on</option>
						<option value='fa fa-toggle-right'>&#xf152; fa-toggle-right</option>
						<option value='fa fa-toggle-up'>&#xf151; fa-toggle-up</option>
						<option value='fa fa-trademark'>&#xf25c; fa-trademark</option>
						<option value='fa fa-train'>&#xf238; fa-train</option>
						<option value='fa fa-transgender'>&#xf224; fa-transgender</option>
						<option value='fa fa-transgender-alt'>&#xf225; fa-transgender-alt</option>
						<option value='fa fa-trash'>&#xf1f8; fa-trash</option>
						<option value='fa fa-trash-o'>&#xf014; fa-trash-o</option>
						<option value='fa fa-tree'>&#xf1bb; fa-tree</option>
						<option value='fa fa-trello'>&#xf181; fa-trello</option>
						<option value='fa fa-tripadvisor'>&#xf262; fa-tripadvisor</option>
						<option value='fa fa-trophy'>&#xf091; fa-trophy</option>
						<option value='fa fa-truck'>&#xf0d1; fa-truck</option>
						<option value='fa fa-try'>&#xf195; fa-try</option>
						<option value='fa fa-tty'>&#xf1e4; fa-tty</option>
						<option value='fa fa-tumblr'>&#xf173; fa-tumblr</option>
						<option value='fa fa-tumblr-square'>&#xf174; fa-tumblr-square</option>
						<option value='fa fa-turkish-lira'>&#xf195; fa-turkish-lira</option>
						<option value='fa fa-tv'>&#xf26c; fa-tv</option>
						<option value='fa fa-twitch'>&#xf1e8; fa-twitch</option>
						<option value='fa fa-twitter'>&#xf099; fa-twitter</option>
						<option value='fa fa-twitter-square'>&#xf081; fa-twitter-square</option>
						<option value='fa fa-umbrella'>&#xf0e9; fa-umbrella</option>
						<option value='fa fa-underline'>&#xf0cd; fa-underline</option>
						<option value='fa fa-undo'>&#xf0e2; fa-undo</option>
						<option value='fa fa-university'>&#xf19c; fa-university</option>
						<option value='fa fa-unlink'>&#xf127; fa-unlink</option>
						<option value='fa fa-unlock'>&#xf09c; fa-unlock</option>
						<option value='fa fa-unlock-alt'>&#xf13e; fa-unlock-alt</option>
						<option value='fa fa-unsorted'>&#xf0dc; fa-unsorted</option>
						<option value='fa fa-upload'>&#xf093; fa-upload</option>
						<option value='fa fa-usd'>&#xf155; fa-usd</option>
						...
						<option value='fa fa-venus'>&#xf221; fa-venus</option>
						<option value='fa fa-venus-double'>&#xf226; fa-venus-double</option>
						<option value='fa fa-venus-mars'>&#xf228; fa-venus-mars</option>
						<option value='fa fa-viacoin'>&#xf237; fa-viacoin</option>
						<option value='fa fa-video-camera'>&#xf03d; fa-video-camera</option>
						<option value='fa fa-vimeo'>&#xf27d; fa-vimeo</option>
						<option value='fa fa-vimeo-square'>&#xf194; fa-vimeo-square</option>
						<option value='fa fa-vine'>&#xf1ca; fa-vine</option>
						<option value='fa fa-vk'>&#xf189; fa-vk</option>
						<option value='fa fa-volume-down'>&#xf027; fa-volume-down</option>
						<option value='fa fa-volume-off'>&#xf026; fa-volume-off</option>
						<option value='fa fa-volume-up'>&#xf028; fa-volume-up</option>
						<option value='fa fa-warning'>&#xf071; fa-warning</option>
						<option value='fa fa-wechat'>&#xf1d7; fa-wechat</option>
						<option value='fa fa-weibo'>&#xf18a; fa-weibo</option>
						<option value='fa fa-weixin'>&#xf1d7; fa-weixin</option>
						<option value='fa fa-whatsapp'>&#xf232; fa-whatsapp</option>
						<option value='fa fa-wheelchair'>&#xf193; fa-wheelchair</option>
						<option value='fa fa-wifi'>&#xf1eb; fa-wifi</option>
						<option value='fa fa-wikipedia-w'>&#xf266; fa-wikipedia-w</option>
						<option value='fa fa-windows'>&#xf17a; fa-windows</option>
						<option value='fa fa-won'>&#xf159; fa-won</option>
						<option value='fa fa-wordpress'>&#xf19a; fa-wordpress</option>
						<option value='fa fa-wrench'>&#xf0ad; fa-wrench</option>
						<option value='fa fa-xing'>&#xf168; fa-xing</option>
						<option value='fa fa-xing-square'>&#xf169; fa-xing-square</option>
						<option value='fa fa-y-combinator'>&#xf23b; fa-y-combinator</option>
						<option value='fa fa-y-combinator-square'>&#xf1d4; fa-y-combinator-square</option>
						<option value='fa fa-yahoo'>&#xf19e; fa-yahoo</option>
						<option value='fa fa-yc'>&#xf23b; fa-yc</option>
						<option value='fa fa-yc-square'>&#xf1d4; fa-yc-square</option>
						<option value='fa fa-yelp'>&#xf1e9; fa-yelp</option>
						<option value='fa fa-yen'>&#xf157; fa-yen</option>
						<option value='fa fa-youtube'>&#xf167; fa-youtube</option>
						<option value='fa fa-youtube-play'>&#xf16a; fa-youtube-play</option>
						<option value='fa fa-youtube-square'>&#xf166; fa-youtube-square</option>
					</optgroup>
				</select>
			</div>
		</div>
		<div class="row">
			<div class="form-group col-md-6">
				<label class="control-label" for="txtopciones">Tendra opciones</label>
				<br>
				<input data-info="<?php echo(isset($info[0]->padre)) ? $info[0]->padre : '' ?>" type="checkbox"  id="txtopciones" name="txtopciones">
			</div>
			<div class="form-group col-md-6">
				<label class="control-label" for="txtenlace">Padre(opcional)</label>
				<select data-info="<?php echo(isset($info[0]->enlace)) ? $info[0]->enlace : '' ?>" name="txtenlace" class="form-control" id="txtenlace">
					<option value="0">Selecione una opción</option>
					<?php
						if(isset($padres)){
							foreach($padres as $padre){
								echo "<option value='".$padre->id."'>".$padre->nombre."</option>";
							}	
						}
					?>
				</select>
...
<script type="text/javascript">
	//console.log($("#txtopciones").val());
	var padre = "<?php echo(isset($info[0]->padre)) ? $info[0]->padre : '' ?>";
	var icono = "<?php echo(isset($info[0]->icono)) ? $info[0]->icono : '' ?>";
	var enlace = "<?php echo(isset($info[0]->enlace)) ? $info[0]->enlace : '0' ?>";
	$("#txticono").val(icono);
	$("#txtenlace").val(enlace);
	if(padre == "1"){
		$('#txtopciones').prop('checked', true);
		$("#txtruta").prop( "disabled", true );
	  	$("#txtruta").val("");
	  	$("#txtenlace").val("");
	  	$("#txtenlace").prop( "disabled", true );
	}
	$("#msg-error").hide();
	$('#txtopciones').checkboxpicker({
	  html: true,
	  offLabel: '<span class="glyphicon glyphicon-remove"> No',
	  onLabel: '<span class="glyphicon glyphicon-ok"> Si'
	});
	$('#txtopciones').checkboxpicker().on('change', function() {
	  if($("#txtopciones").is(":checked")){
	  	...
	  	$("#txtruta").prop( "disabled", false );
	  	$("#txtenlace").prop( "disabled", false );
	  }
	});
</script>
